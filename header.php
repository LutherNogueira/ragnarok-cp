        ...
        <div class="container"> <button class="navbar-toggler navbar-toggler-right border-0 p-0" type="button" data-toggle="collapse" data-target="#navbar20">
          ...
          <div class="collapse navbar-collapse" id="navbar20">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item"> <a class="nav-link" href="index.php"><i class="fa fa-user fa-fw"></i>Home</a> </li>
              <li class="nav-item"> <a class="nav-link" href="singup.php"><i class="fa fa-user fa-fw"></i>Account</a> </li>
              <li class="nav-item"> <a class="nav-link" href="itemdb.php" onclick="itemDbList()"><i class="fa fa-user fa-fw"></i>Database</a> </li>
            </ul>
